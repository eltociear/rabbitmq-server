...
do_load_conf_env_file(#{os_type := {win32, _}} = Context, Cmd, ConfEnvFile0) ->
    ...
    RE = "\\.(conf|config)$",
    MainConfigFile = re:replace(DefaultMainConfigFile, RE, "", [{return, list}]),
...
normalize_path(P0, P1, P2, P3, P4) ->
    normalize_path(filename:join([P0, P1, P2, P3, P4])).

normalize_path(P0, P1, P2, P3) ->
    normalize_path(filename:join([P0, P1, P2, P3])).

normalize_path(P0, P1, P2) ->
    normalize_path(filename:join([P0, P1, P2])).
